...
uniform float	  uInRows;      // size of input in rows                 \n\
uniform float	  uInCols;      // size of input in columns              \n\
																		 \n\
// sum row r x col c                                                     \n\
...
void main(void) {                                                        \n\
	...
	float col = floor((vTex.x*uInCols));                                 \n\
	float row = floor((vTex.y*uInRows));                                 \n\
																		 \n\
 ...
 */
GEMMFloatCalculator.prototype.setupInputTexture = function(h, w, texels){
...
GEMMFloatCalculator.prototype.calculate = function(m, n, k, alpha, A, B, beta, C){
	...
	this.setupInputTexture(h, w, texels);
	...
	frameBuffer = this.bindFramebuffer(destTexture, m, n);
