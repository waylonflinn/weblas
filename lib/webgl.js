...
WebGL.prototype.reshape = function(M, N, M_out, N_out, texture0, out){
	...
	this.context.uniform1i(M_gl, M_out);
	this.context.uniform1i(N_gl, N_out);
	this.context.uniform1i(pad_gl, pad_out);
	this.context.uniform1i(M_in_gl, M);
	this.context.uniform1i(N_in_gl, N);
	this.context.uniform1i(pad_in_gl, pad);
