...
/* A calculator object for the Float texture based GEMM
	...
	standalone mode compiles in the float encoder (this is required for mobile,
	circa 2015) but can't be used as part of a pipeline.
...
SGEMMCalculator.prototype.calculate = function(M, N, K, alpha, A, B, beta, C){
	...
	*/
	...
	this.webgl.bindDestinationTexture(M, N, C);
