 ...
 */
function SGEMMCalculator(webgl){
	this.webgl = webgl;
	...
	this.program = this.webgl.createProgram(SGEMMCalculator.FRAGMENT_SHADER);
 ...
 */
SGEMMCalculator.FRAGMENT_SHADER = "                                  \n\
 ...
 */
SGEMMCalculator.prototype.calculate = function(M, N, K, alpha, A, B, beta, C){
	...
	*/
	...
	var texels0 = SGEMMCalculator.packData(M, K, A, false);
		texels1 = SGEMMCalculator.packData(K, N, B, true);
	...
	this.bindInputTexture(M, K + pad, texels0, gl.TEXTURE0, SGEMMCalculator.TEXTURE_UNIFORM_NAME_0);
	this.bindInputTexture(N, K + pad, texels1, gl.TEXTURE1, SGEMMCalculator.TEXTURE_UNIFORM_NAME_1);
 ...
 */
SGEMMCalculator.packData = function(r, c, data, transpose) {
...
*/
SGEMMCalculator.prototype.bindInputTexture = function(h, w, texels, textureUnit, name){
	var gl = this.webgl.context,
